...
/* Cache of previously seen amd64 target descriptions, indexed by the xcr0
   value that created the target description.  */

static tdesc_cache_type amd64_tdesc_cache;

/* Cache of previously seen x32 target descriptions, indexed by the xcr0
   value that created the target description.  */

static tdesc_cache_type x32_tdesc_cache;
...
{
  tdesc_cache_type &tdesc_cache
    = is_x32 ? x32_tdesc_cache : amd64_tdesc_cache;
