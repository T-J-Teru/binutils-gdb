...
list_command (const char *arg, int from_tty)
{
  ...
  if (*arg1 == ',')
  ...
  else
    {
      ...
      /* If END_PTR is different to ARG1 then strtoll parsed something, but
	 strtoll will accept numbers with a '+' or '-' prefix, which we
      ...
      if (end_ptr != arg1 && c_isdigit (*arg1))
	{
	  ...
	  /* Check for valid line format, of for invalid line number.  */
