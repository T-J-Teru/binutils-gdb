...
{
      22,     0,    -1,    23,    -1,    27,    -1,    25,    -1,    26,
      -1,    24,    -1,    28,    -1,    29,    -1,    16,     7,    17,
      12,    38,    35,    -1,    16,     7,    17,     6,    38,    41,
      -1,    16,     7,    17,     6,    17,     4,    30,    40,    -1,
      16,     7,    17,     6,    17,    10,    30,    40,    32,    39,
      -1,    16,     7,    17,    11,    17,     3,    30,    37,    18,
      36,    -1,    16,     7,    17,     5,    17,     9,    30,    37,
      18,    36,    18,    34,    -1,    19,     7,    17,     8,    17,
       9,    30,    37,    18,    36,    31,    33,    -1,    20,    -1,
      18,    -1,    18,    -1,    14,    -1,    15,    -1,    13,    -1,
      15,    -1,    15,    -1,    20,    -1,    13,    -1,    15,    -1,
      13,    -1
};
...
static const char *const yytname[] =
{
  ...
  "begin_id_arg1", "member_name", "type_id", "type_name", 0
};
#endif
...
/* Line 1806 of yacc.c  */
#line 113 "uda-rmt-client-cmd.y"
    {
	      const char *symbol = (yyvsp[(6) - (6)].str);
	      uda_taddr_t address;
	      int status;
...
/* Line 1806 of yacc.c  */
#line 128 "uda-rmt-client-cmd.y"
    {
	      const char *type_name = (yyvsp[(6) - (6)].str);
	      uda_tword_t type_id;
	      int status;
...
/* Line 1806 of yacc.c  */
#line 143 "uda-rmt-client-cmd.y"
    {
	      const uda_tword_t type_id = (yyvsp[(8) - (8)].val);
...
/* Line 1806 of yacc.c  */
#line 158 "uda-rmt-client-cmd.y"
    {
	      const uda_tword_t type_id = (yyvsp[(8) - (10)].val);
	      const char *member_name = (yyvsp[(10) - (10)].str);
...
/* Line 1806 of yacc.c  */
#line 178 "uda-rmt-client-cmd.y"
    {
	      const uda_taddr_t address = (yyvsp[(8) - (10)].val);
	      const uda_tword_t thread_num = (yyvsp[(10) - (10)].val);
...
/* Line 1806 of yacc.c  */
#line 195 "uda-rmt-client-cmd.y"
    {
	      const uda_taddr_t addr = (yyvsp[(8) - (12)].val);
	      const uda_tword_t thread_num = (yyvsp[(10) - (12)].val);
	      const uda_tword_t length = (yyvsp[(12) - (12)].val);
	      uda_binary_data_t data;
	      int status;
...
/* Line 1806 of yacc.c  */
#line 216 "uda-rmt-client-cmd.y"
    {
	      const uda_taddr_t address = (yyvsp[(8) - (12)].val);
	      const uda_tword_t thread_num = (yyvsp[(10) - (12)].val);
	      const uda_binary_data_t data = (yyvsp[(12) - (12)].data);
...
/* Line 1806 of yacc.c  */
#line 261 "uda-rmt-client-cmd.y"
    { (yyval.val) = (uda_taddr_t)(yyvsp[(1) - (1)].val); }
    break;

  case 24:

/* Line 1806 of yacc.c  */
#line 265 "uda-rmt-client-cmd.y"
    { yysstate = scan_id; }
    break;
...
/* Line 1806 of yacc.c  */
#line 1636 "uda-rmt-client-cmd.c"
      default: break;
    }
