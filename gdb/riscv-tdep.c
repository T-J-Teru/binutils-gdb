  ...
  if (regnum > RISCV_LAST_REGNUM)
    {
	 ...
	 These registers are also removed from the general groups as CSRs
	 should not be displayed in this group.

	 Thee unknown CSRs are however, placed into the system and csr
	 register groups, which should match the behaviour of other
	 CSRs.  */
