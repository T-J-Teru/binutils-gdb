...
START_RELOC_NUMBERS (elf_mrk3_reloc_type)
  ...
  RELOC_NUMBER (R_MRK3_32,     4)
  RELOC_NUMBER (R_MRK3_HIGH16, 5)
  RELOC_NUMBER (R_MRK3_WORD16, 6)
  RELOC_NUMBER (R_MRK3_ABS_HI, 7)
  RELOC_NUMBER (R_MRK3_ABS_LO, 8)
  RELOC_NUMBER (R_MRK3_AUTO16, 9)
  RELOC_NUMBER (R_MRK3_PCREL16, 10)
  RELOC_NUMBER (R_MRK3_PCREL8, 11)
  RELOC_NUMBER (R_MRK3_FORCEPCREL16, 10)
  RELOC_NUMBER (R_MRK3_FORCEPCREL8, 11)
END_RELOC_NUMBERS (R_MRK3_max)
