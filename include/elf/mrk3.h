...
START_RELOC_NUMBERS (elf_mrk3_reloc_type)
  ...
  RELOC_NUMBER (R_MRK3_ABS_JT16,     21)
  RELOC_NUMBER (R_MRK3_ABS_BYTE1,    22)
  RELOC_NUMBER (R_MRK3_ABS_BYTE2,    23)
  RELOC_NUMBER (R_MRK3_ABS_BYTE3,    24)
  RELOC_NUMBER (R_MRK3_ABS_BYTE4,    25)
  RELOC_NUMBER (R_MRK3_PIC,          26)
  RELOC_NUMBER (R_MRK3_PIC_LO,       27)
  RELOC_NUMBER (R_MRK3_SPIC,         28)
  RELOC_NUMBER (R_MRK3_SPIC_LO,      29)
END_RELOC_NUMBERS (R_MRK3_max)
