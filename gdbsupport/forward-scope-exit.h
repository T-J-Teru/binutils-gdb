...
public:
  ...
  void operator= (forward_scope_exit_policy &&) = delete;
  forward_scope_exit_policy (forward_scope_exit_policy &&) = delete;
...
template<typename Function, Function *function,
	 typename Res, typename... Args>
using forward_scope_exit = scope_exit_base<forward_scope_exit_policy<Function, function, Res, Args...>>;
