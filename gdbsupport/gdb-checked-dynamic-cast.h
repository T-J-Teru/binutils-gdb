...
/* This function can be used in place of dynamic_cast when casting between
   pointers of polymorphic types in situations where we don't expect a
   nullptr result.  */

template<typename T, typename V>
T
checked_dynamic_cast (V *v)
{
  ...
  gdb_assert (v == nullptr || result != nullptr);
